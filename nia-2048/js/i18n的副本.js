...
function use_traditional(){
  ...
  當兩塊相同的磚碰在一起時，<strong>它們會併成一塊更好的磚</strong>！<br>但是，你的想法和實驗可能只是產生<strong>垃圾</strong>而已。
  黏在地上的垃圾會阻礙磚塊移動，直到被別的垃圾擊中而消失。你得到 <strong>paper</strong> 以後便不會再產生垃圾，最多再出一塊幫你清除場上剩下的垃圾。<br><strong>戀愛</strong>磚觸碰任何磚都能使其升級，但一塊磚只得升級一次。戀愛磚上會顯示你用它的次數。10 秒後它會變成<strong>分手</strong>磚，觸碰任何磚都能使其降級，以此來償還之前使用的次數。";
...
"公主肉","高贵肉",
 "赫本肉","活力肉", "乖乖肉", 
 "甜甜肉",
  "搞怪肉","<span style='display:inline-block;line-height:25px;vertical-align:middle'>我见犹怜肉</span>",  "心头肉"
  ];
  ...
  "<span style='display:inline-block;line-height:25px;font-size:smaller;vertical-align:middle'>Soda<br>Nia</span>",
  "<span style='display:inline-block;line-height:25px;font-size:16px;vertical-align:middle'>Blueberry<br>Nia</span>",
    ...
    "<span style='font-size:smaller'>Funny<br>Nia</span>",
